...
LABELS_PATH = "/Volumes/My Passport for Mac/data/simpsons-labels/labels.csv"
        ...
        if file and allowed_file(file.filename):
            ...
            if not (output is None):
                for imageUrl,character in output.items():
                    print(imageUrl)
                    print(character)
            return render_template('classifysimpsons.html', character=character ,output=output)
    else:
    	return render_template('classifysimpsons.html', review="" ,output=None)
